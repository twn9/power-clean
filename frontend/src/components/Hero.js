...
export default function Hero() {
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ backgroundImage: `url(${hero2})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
      <div className="container mx-auto px-4 py-10 flex items-center justify-between">
        ...
        <div className="text-left">
          ...
          <p className="text-gray-200 mt-2">Making your driveway look new!</p>
